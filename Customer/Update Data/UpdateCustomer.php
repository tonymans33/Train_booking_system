...
<div class="w3-panel w3-padding-16 w3-black w3-opacity w3-card w3-hover-opacity-off" style=" width:480px;height: 420px;margin-left: 510px;border-radius: 25px;margin-top: 200px;">
    <center>
        ...
        <div >
            ...
            <form action="#" method="POST" style="opacity: 90%;">
                ...
                <input style="width: 350px;" class="w3-link w3-round-xlarge" type="text" name="new_email" placeholder="<?php echo $email; ?>" ><br>
                <button type="submit"  class="w3-button w3-red w3-margin-top" style="border-radius: 25px;" name="update_submit" >Update</button><br><br>
                <a href="ChangePasswordCustomer.php" style="color:white;">Change Password ?</a>

            </form>
            <br>
            <a href="../WelcomeCustomer.php" style="color:white;">Back to your Page</a><br><br>
            <br>
