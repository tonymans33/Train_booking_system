...
$InTripBooked = "INSERT INTO tripbooked(booker , tripid , numofseats,Payed) VALUES('$booker' , '$id' ,'$NumOfSeats','$payed') ";
...
$massage = "Thank you for using BrTrain.com ..You have purchased ".$NumOfSeats."ticket to trip number".$id;
...
<div class="w3-half w3-margin-bottom" style=" border-radius: 25px;">
        ...
        <div class="w3-panel w3-padding-16 w3-black w3-opacity w3-card w3-hover-opacity-off" style="border-radius: 25px; width: 985px;height: 320px; margin-left: 275px; margin-top: 100px;">
            <center>
                <h1><strong><?php echo $booker; ?></strong> You have purchased a <strong><?php echo $NumOfSeats;?></strong> tickets For trip number : <strong><?php echo $id; ?></strong></h1>
